...
- Dirge commits, pushes, and creates PRs. Code runs use sandbox `off` so Git can write worktree metadata; the plugin blocks force pushes and requires checks first.
